...
一个基于 HTML5 Canvas 的 2D 九球游戏，包含本地双人对战、规则说明页和 WebSocket 联机版本。

## 在线试玩

本地游戏页面：

[点击开始游戏](https://akiteet.github.io/table_tennis/nine_ball/nine_ball-game/game_2d.html)

规则说明页面：

[查看规则说明](https://akiteet.github.io/table_tennis/nine_ball/nine_ball-game/game_2d_rules.html)

联机游戏页面：

[进入联机对战](https://akiteet.github.io/table_tennis/nine_ball/nine_ball-game/game_2d_online.html)
...
[https://akiteet.github.io/table_tennis/nine_ball/nine_ball-game/game_2d_online.html](https://akiteet.github.io/table_tennis/nine_ball/nine_ball-game/game_2d_online.html)
...
- 使用10颗球：1颗白色主球和1-9号目标球
- 目标球排列成菱形，1号球在最前面，9号球在中心
- 核心规则：母球必须首先撞击台面上最小号的球
- 获胜条件：将9号球合法打入袋中
- 开球时母球必须首先触击1号球
- 合法开球条件：至少有1颗目标球入袋，或者至少有4颗目标球触及库边
- 开球进9号球直接获胜（金九）
- 犯规后对手获得自由球（全场任意球）
- 连续三次犯规直接判负
...
这是一个前端练习项目，主要用于实现 2D 球类碰撞、游戏状态机、九球规则判定和基础联机同步。
